...
public class App {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println("Connecting from 0 to 1: " + v1.connectsTo(v2) + " with
        // weight " + v1.weightTo(v2));
        // System.out.println("Connecting from 3 to 1: " + v4.connectsTo(v2) + " with
        // weight " + v4.weightTo(v2));
        // System.out.println("Connecting from 1 to 0: " + v2.connectsTo(v1));
        // System.out.println("Connecting from 1 to 1: " + v2.connectsTo(v2) + " with
        // weight " + v2.weightTo(v2) + "\n");
        ...
        // g2.getShortestPath(3, 2));
        // System.out.println("Shortest path from 3 to 3... : " + g2.getShortestPath(3,
        // 3));
